...
HD_PWD='E:/sp20work/E315/led_blink/led_blink.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_blink_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_blink_wrapper.tcl
