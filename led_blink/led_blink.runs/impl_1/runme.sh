...
HD_PWD='E:/sp20work/E315/led_blink/led_blink.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_blink_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_blink_wrapper.tcl -notrace
