...
################################################################
# This is a generated script based on design: bitcounter
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: AXI_bitcount_0, and set properties
  set block_name AXI_bitcount
  set block_cell_name AXI_bitcount_0
  if { [catch {set AXI_bitcount_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $AXI_bitcount_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins AXI_bitcount_0/S_AXIS] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_bitcount_0/S_AXI/reg0] SEG_AXI_bitcount_0_reg0
