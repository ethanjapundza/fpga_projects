...
HD_PWD='/home/ejapundz/fa19-research/E315/project_4/project_4.runs/bitcounter_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bitcounter_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bitcounter_xbar_0.tcl
