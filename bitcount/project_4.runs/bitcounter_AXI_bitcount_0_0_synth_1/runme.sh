...
HD_PWD='/nfs/nfs7/home/ejapundz/sp20-e315/E315/project_4/project_4.runs/bitcounter_AXI_bitcount_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bitcounter_AXI_bitcount_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bitcounter_AXI_bitcount_0_0.tcl
