...
#
# Generated by export_simulation on Tue Jan 07 15:30:03 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './design_tb.sh' script.

./design_tb.sh -reset_run
...
./design_tb.sh -noclean_files

For more information on the script, please type './design_tb.sh -help'.
