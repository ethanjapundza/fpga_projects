...
//Date        : Mon Feb 24 16:08:30 2020
//Host        : if4111linux-15.luddy.indiana.edu running 64-bit Red Hat Enterprise Linux Workstation release 7.7 (Maipo)
//Command     : generate_target design_tb_sim2.bd
//Design      : design_tb_sim2
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "design_tb_sim2,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_tb_sim2,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,synth_mode=Global}" *) (* HW_HANDOFF = "design_tb_sim2.hwdef" *) 
module design_tb_sim2
   (ACLK_0,
    ARESETN_0);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK_0, ASSOCIATED_RESET ARESETN_0, CLK_DOMAIN design_tb_sim2_ACLK_0, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input ACLK_0;
  ...
  design_tb_sim2_axi4stream_vip_0_0 axi4stream_vip_0
       (.aclk(ACLK_0_1),
        .aresetn(ARESETN_0_1),
  ...
  design_tb_sim2_axi4stream_vip_1_0 axi4stream_vip_1
       (.aclk(ACLK_0_1),
        .aresetn(ARESETN_0_1),
  ...
  design_tb_sim2_axis_ema_0_0 axis_ema_0
       (.ACLK(ACLK_0_1),
        .ARESETN(ARESETN_0_1),
