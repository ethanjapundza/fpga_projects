...
#
# Generated by export_simulation on Mon Feb 24 16:08:31 EST 2020
#
################################################################################
...
'-reset_run' switch to the './design_tb_sim2.sh' script.

./design_tb_sim2.sh -reset_run
...
./design_tb_sim2.sh -noclean_files

For more information on the script, please type './design_tb_sim2.sh -help'.
