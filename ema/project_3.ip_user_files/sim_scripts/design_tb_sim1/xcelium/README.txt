...
#
# Generated by export_simulation on Mon Feb 10 06:25:16 PST 2020
#
################################################################################
...
'-reset_run' switch to the './design_tb_sim1.sh' script.

./design_tb_sim1.sh -reset_run
...
./design_tb_sim1.sh -noclean_files

For more information on the script, please type './design_tb_sim1.sh -help'.
