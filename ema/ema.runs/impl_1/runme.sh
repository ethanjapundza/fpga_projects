...
HD_PWD='/home/ejapundz/fa19-research/ema/ema.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ema_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ema_bd_wrapper.tcl -notrace
