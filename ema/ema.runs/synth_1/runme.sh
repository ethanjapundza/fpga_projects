...
HD_PWD='/home/ejapundz/fa19-research/ema/ema.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ema_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ema_bd_wrapper.tcl
