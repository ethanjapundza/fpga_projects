...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ema is
  port (
    ...
    \y_reg[31]_1\ : in STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ema is
  ...
  signal \y_reg[11]_i_1_n_4\ : STD_LOGIC;
  ...
  signal \y_reg[15]_i_1_n_4\ : STD_LOGIC;
  signal \y_reg[15]_i_1_n_5\ : STD_LOGIC;
  signal \y_reg[15]_i_1_n_6\ : STD_LOGIC;
  signal \y_reg[15]_i_1_n_7\ : STD_LOGIC;
  ...
  signal \^y_reg[31]_0\ : STD_LOGIC_VECTOR ( 31 downto 0 );
  signal \y_reg[31]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \NLW_y_reg[31]_i_2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 to 2 );
  signal \NLW_y_reg[31]_i_2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
begin
  en0 <= \^en0\;
  \y_reg[31]_0\(31 downto 0) <= \^y_reg[31]_0\(31 downto 0);
\y[11]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\y[11]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\y[15]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\y[15]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\y[19]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\y_reg[15]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(3) => \y_reg[15]_i_1_n_4\,
      O(2) => \y_reg[15]_i_1_n_5\,
      O(1) => \y_reg[15]_i_1_n_6\,
      O(0) => \y_reg[15]_i_1_n_7\,
      S(3) => \y[15]_i_2_n_0\,
      S(2) => \y[15]_i_3_n_0\,
      S(1) => \y[15]_i_4_n_0\,
      S(0) => \y[15]_i_5_n_0\
...
\y_reg[31]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \y_reg[31]_i_2_n_0\,
      CO(2) => \NLW_y_reg[31]_i_2_CO_UNCONNECTED\(2),
      CO(1) => \y_reg[31]_i_2_n_2\,
      CO(0) => \y_reg[31]_i_2_n_3\,
      CYINIT => '0',
      DI(3) => '0',
      DI(2 downto 0) => Q(30 downto 28),
      O(3) => \NLW_y_reg[31]_i_2_O_UNCONNECTED\(3),
