...
HD_PWD='/home/ejapundz/bitflip/bitflip.runs/bitflip_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bitflip_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bitflip_xbar_0.tcl
