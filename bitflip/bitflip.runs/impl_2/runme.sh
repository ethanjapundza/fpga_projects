...
HD_PWD='/home/ejapundz/fa19-research/E315/bitflip/bitflip.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log bitflip_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bitflip_wrapper.tcl -notrace
