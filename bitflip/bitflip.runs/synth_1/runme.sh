...
HD_PWD='/home/ejapundz/fa19-research/E315/bitflip/bitflip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bitflip_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bitflip_wrapper.tcl
