...
HD_PWD='/home/ejapundz/fa19-research/E315/bitflip/bitflip.runs/bitflip_bit_flip_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bitflip_bit_flip_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bitflip_bit_flip_0_2.tcl
