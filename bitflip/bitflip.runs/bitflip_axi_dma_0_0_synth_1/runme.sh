...
HD_PWD='/home/ejapundz/bitflip/bitflip.runs/bitflip_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bitflip_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bitflip_axi_dma_0_0.tcl
