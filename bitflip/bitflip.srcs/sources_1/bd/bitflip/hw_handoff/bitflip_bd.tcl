...
################################################################
# This is a generated script based on design: bitflip
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: bit_flip_0, and set properties
  set block_name bit_flip
  set block_cell_name bit_flip_0
  if { [catch {set bit_flip_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $bit_flip_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins bit_flip_0/s_axis]
...
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axi_dma_0_M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net bit_flip_0_m_axis [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins bit_flip_0/m_axis]
connect_bd_intf_net -intf_net [get_bd_intf_nets bit_flip_0_m_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets bit_flip_0_m_axis]
