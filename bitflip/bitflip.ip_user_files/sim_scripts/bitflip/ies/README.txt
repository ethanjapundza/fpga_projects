...
#
# Generated by export_simulation on Tue Jan 07 10:57:35 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './bitflip.sh' script.

./bitflip.sh -reset_run
...
./bitflip.sh -noclean_files

For more information on the script, please type './bitflip.sh -help'.
