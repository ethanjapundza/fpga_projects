...
HD_PWD='/home/ejapundz/fa19-research/E315/project_2.tar/project_2/project_2.runs/mult_AXI_mult_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_AXI_mult_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_AXI_mult_0_0.tcl
